...
import { type AdmissionInquiry, createColumns } from './columns';
...
export default function AdmissionInquiriesIndex({ inquiries }: Props) {
    const [deletingId, setDeletingId] = useState<number | null>(null);

    function handleDelete() {
        if (!deletingId) return;
        router.delete(`/admin/admission-inquiries/${deletingId}`, {
            onSuccess: () => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4">
                <div>
                    <h1 className="text-2xl font-semibold text-foreground">Admission Inquiries</h1>
